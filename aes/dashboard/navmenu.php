<div class="wrapper">
      <header class="main-header hidden-print"><a class="logo" href="https://blogbugabagi.blogspot.com" target="_blank" rel="noopener noreferrer" style="font-size:13pt"><img src="../assets/images/lg.png" width="45px" alt="" srcset=""><strong>AES</strong></a>
